...
cd ./views/la; npm install; npm run-script build; cd ../..;
cd ./views/labreak; npm install; npm run-script build; cd ../..;
cd ./views/lalunch; npm install; npm run-script build; cd ../..;
cd ./views/ladinner; npm install; npm run-script build; cd ../..;
cd ./views/lacoffee; npm install; npm run-script build; cd ../..;
cd ./views/labars; npm install; npm run-script build; cd ../..;
